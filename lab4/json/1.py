...
for item in d["imdata"]:
    for i in item["l1PhysIf"]["attributes"]:
        if i == "dn":
            l.append(item["l1PhysIf"]["attributes"]["dn"])
        if i == "speed":
            speed.append(item["l1PhysIf"]["attributes"]["speed"])
        if i == "mtu":
            mtu.append(item["l1PhysIf"]["attributes"]["mtu"])

print()
for i in range(len(l)):
    print(l[i]+"                              "+speed[i] +"   " + mtu[i])